        ...
        private suspend fun populateDatabase(beachDao: BeachDAO) {
            val sampleBeaches = listOf(
                Beach(
                    ...
                    favourite = false,
                    image = R.drawable.playawaikiki, // Placeholder
                ...
                Beach(
                    ...
                    favourite = false,
                    image = R.drawable.playapuntahermosa,
                ...
                Beach(
                    ...
                    location = "Punta Hermosa, Lima",
                    favourite = false,
                    image = R.drawable.playaelsilencio,
                    ocupation = Ocupation.ALTA,
                    sea = "Pacífico",
                    windSpeed = 10.0,
                ...
                Beach(
                    ...
                    location = "Punta Hermosa, Lima",
                    favourite = false,
                    image = R.drawable.playasenioritas,
                    ocupation = Ocupation.MEDIA,
                    sea = "Pacífico",
                    windSpeed = 11.0,
                ...
                Beach(
                    ...
                    favourite = false,
                    image = R.drawable.playasanbartolo,
                    ocupation = Ocupation.MEDIA,
                    sea = "Pacífico",
                    windSpeed = 9.5,
                ...
                Beach(
                    ...
                    favourite = false,
                    image = R.drawable.playasantamaria,
                ...
                Beach(
                    ...
                    favourite = false,
                    image = R.drawable.playapescadores,
                    ocupation = Ocupation.ALTA,
                    sea = "Pacífico",
                    windSpeed = 9.0,
                ...
                Beach(
                    ...
                    location = "Miraflores, Lima",
                    favourite = false,
                    image = R.drawable.playapampilla,
                    ocupation = Ocupation.ALTA,
                    sea = "Pacífico",
                    windSpeed = 10.0,
